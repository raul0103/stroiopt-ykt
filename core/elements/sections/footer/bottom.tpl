<div class="footer__bottom">
  ...
  <div class="footer__bottom-devcompany">
    <a
      ...
      class="footer__bottom-devcompany__logo has-icon has-icon-devcompany"
    ></a>
    <div class="footer__bottom-devcompany__text fs-body-2">
      <div class="dark-color">Разработка и продвижение сайта</div>
